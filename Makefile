.PHONY: install test demo demo-live certificate certificate-check certificate-verify anchor-check gold-v2-check annotation-pack migrate-gold-v2 capture-check replay-check live-run-report live-run-check robustness robustness-check check
...
check: test anchor-check gold-v2-check capture-check replay-check live-run-check certificate-check certificate-verify robustness-check
